Public Class Form1
    ...
    Private Sub GameTimer_Tick(sender As Object, e As EventArgs) Handles GameTimer.Tick
        ...
        'Draw the ship
        framePen.DrawImage(My.Resources.ship, 0, 300)


        'Recycle the ship


        'Animate the moon to go from top to bottom and recycle


        'Animate a 2nd moon to go from bottom to top and recycle
